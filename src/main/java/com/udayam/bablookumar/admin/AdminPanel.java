package com.udayam.bablookumar.admin;
import java.net.URI;
...
//        try {
//           
//            System.out.println("ConstantsSample.SERVER_URL:  "+ConstantsSample.SERVER_URL+" :EndPoint:  "+endpoint);
//            Builder builder = HttpRequest.newBuilder();
//            builder.uri(new URI(ConstantsSample.SERVER_URL+endpoint));
//            builder.header("Content-Type", "application/json");
//            builder.header("Authorization", ConstantsSample.APP_PASSWORD);
